...
//   const filteredResidents = selectedYear
//     ? residents.filter((r) => r.date_of_birth.startsWith(selectedYear))
//     : residents;
...
//                   className="bg-green-600 hover:bg-green-700 text-white px-5 py-2 rounded-md w-full sm:w-auto"
//                 >
//                   Save
//                 </button>
//               </div>
...
//     <div className="flex justify-center w-full">
//       <div className="w-[95%] max-w-screen-xl">
//         <div className="flex justify-between items-center gap-4 mt-24 mb-5 flex-wrap">
//           <DropdownYearResident
//             selectedYear={selectedYear}
//             setSelectedYear={setSelectedYear}
//           />
...
//             className="p-2 border border-gray-400 rounded-md flex-grow focus:outline-none focus:ring-2 focus:ring-green-500"
//           />
//           <button
